    ...
    return (
        <div>
            {/* <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8 border-t border-gray-800">
                ...
                <div className="mt-10 grid grid-cols-1 gap-16 sm:grid-cols-2 lg:grid-cols-4 justify-items-center">
                    {developers
                        ?.filter((dev) => dev && dev.src)
                        .map((developer) => (
                        <div key={developer?.id} className="flex flex-col items-center text-center max-w-xs">
            ...
            <div className="min-h-[160px] flex items-center justify-center">
                <p className="text-gray-600">Copyright © 2025 Harsh Kumar</p>
            </div>
        </div>
    );
};
