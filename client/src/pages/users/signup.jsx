...
export default function signup({ userIdCookie }) {
    ...
    const handleSubmit = async (event) => {
        event.preventDefault();
        // allow either old format (2 digits + 3 letters + 5 digits)
        // or VIT-style format like BCAN1CA23033 (4 letters + 1 digit + 2 letters + 5 digits)
        const regExp = /^(?:\d{2}[A-Za-z]{3}\d{5}|[A-Za-z]{4}\d[A-Za-z]{2}\d{5})$/;
